...
Java_com_huibendawang_audiomixing_FFBufferEncoder_startEncode(JNIEnv *env, jobject instance,
...
JNIEXPORT jint JNICALL
Java_com_huibendawang_audiomixing_FFBufferEncoder_appendData(JNIEnv *env, jobject instance,
...
JNIEXPORT jint JNICALL
Java_com_huibendawang_audiomixing_FFBufferEncoder_endInput(JNIEnv *env, jobject instance) {
    int error = 0;
    if (glf_encoder) {
